package pl.sda.converter.excell;
...
class ExcelWriter implements SDAFileWriter {

    @Override
    public void write(List<Map<String, Object>> records, String path) {
        ...
        for (Map<String, Object> record : records) {
            ...
            for (String header : headers) {
                ...
                cell.setCellValue(record.get(header).toString());
                cellCounter++;
            }
            rowCounter++;
        }
